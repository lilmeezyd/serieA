...
const DeleteModal = (props) => {
  const {show, closeDelete, cancelDelete, deleteLeagueNow} = props
  return (
    <Modal show={show} onHide={closeDelete}> 
        <Modal.Header style={{ background: "aquamarine" }} closeButton>
            <Modal.Title><div className="info-details">Delete Private League</div></Modal.Title>
        </Modal.Header>
        <Modal.Body> 
          ...
          <div className="delete-buttons mt-2">
            ...
            <Button onClick={deleteLeagueNow} className="btn-danger">Delete</Button>
          </div>
          </div>
